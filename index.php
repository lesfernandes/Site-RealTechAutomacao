      ...
      <div class="row agile_gallery_grids">
         <div class="col-lg-4 col-md-6 col-sm-6 col-6 agile_gallery_grid">
            <div class="hover ehover14" id="hoverServices">
               <a href="paineis">
                  <img src="images/painel.jpg" alt=" " class="img-fluid" />
                  <div class="overlay">
         ...
         <div class="col-lg-4 col-md-6 col-sm-6 col-6 agile_gallery_grid">
            <div class="hover ehover14" id="hoverServices">
               <a href="iluminacao">
                  <img src="images/iluminacao.jpg" alt=" " class="img-fluid" />
                  <div class="overlay">
                     <h4>ILUMINAÇÃO INDUSTRIAL</h4>
                  </div>
               </a>
         ...
         <div class="col-lg-4 col-md-6 col-sm-6 col-6 agile_gallery_grid">
            <div class="hover ehover14" id="hoverServices">
               <a href="postos">
                  <img src="images/posto.jpg" alt=" " class="img-fluid" />
                  <div class="overlay">
         ...
         <div class="col-lg-4 col-md-6 col-sm-6 col-6 agile_gallery_grid grid1">
            <div class="hover ehover14" id="hoverServices">
               <a href="energiaFotovoltaica">
                  <img src="images/energiaFotovoltaica/e4.jpg" alt=" " class="img-fluid" />
                  <div class="overlay">
                     <h4>ENERGIA FOTOVOLTAICA</h4>
                  </div>
               </a>
...
<div class="service" id="servicesPhone">
   <div class="container">
      <div class="w3ls_banner_bottom_grids agileinfo_testimonial_grids">
         <div class="service-info">
            <h3 class="title" id="titleServices">SERVIÇOS</h3>
      ...
      <div class="row agile_gallery_grids">
         ...
         <div class="col-lg-4 col-md-6 col-sm-6 col-6 agile_gallery_grid grid1">
            <div class="hover ehover14" id="hoverServices">
               <a href="spda">
                  <img src="images/manutencao.jpg" alt=" " class="img-fluid" />
                  <div class="overlay">
                     <h4 id="spda">SPDA - SISTEMAS DE PROTEÇÃO CONTRA DESCARGAS ATMOSFÉRICAS</h4>
                  </div>
               </a>
